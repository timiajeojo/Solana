    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-purple-100">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">Here's your Solana investment overview</p>
        </div>
            ...
            <div className="space-y-5">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent text-black text-lg"
                  placeholder="0.00"
                  step="0.0001"
                />
              </div>
              <div>
                ...
                <input
                  type="number"
                  value={newInvestment.pricePerSol}
                  onChange={(e) => setNewInvestment({ ...newInvestment, pricePerSol: e.target.value })}
                  className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent text-black text-lg"
                  placeholder="0.00"
                  step="0.01"
                />
              ...
              <div className="flex gap-3 mt-8">
                <button
                  ...
                  className="flex-1 px-6 py-3 border-2 border-gray-300 text-black rounded-xl hover:bg-gray-50 transition-colors font-semibold"
                >
                  Cancel
                </button>
                <button
